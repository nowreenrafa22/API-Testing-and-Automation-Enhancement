...
update_url = "http://34.143.149.203:8088/api/config/v1/update-lookup"
login_credential = {
...
if access_token:
    ...
    with open('update lookup\input_update_lookup.csv', 'r', newline='') as create_file, \
         open('update lookup\output_update_lookup.csv', 'w', newline='', encoding='utf-8') as output_file:
